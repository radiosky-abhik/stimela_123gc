...
##########################################################################
# Simulate & add back the final lsm model in the corrected data/ data & then do
# a final amp & phase self-cal with the final model.
#########################################################################
...
# Third selfcal round with amp & phase on the residual + model data
...
recipe.add("cab/calibrator", "calibrator_Gjones_subtract_lsm4", 
           {
